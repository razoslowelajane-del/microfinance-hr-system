...
function openModal(data) {
    ...
    document.getElementById("officerRemarks").value = data.OfficerNotes || "";
...
function bindEvents() {
    ...
    approveBtn.addEventListener("click", async () => {
        ...
        const result = await Swal.fire({
            ...
            text: "This will endorse the leave request to HR.",
        ...
        try {
            ...
            await Swal.fire({
                ...
                icon: "success",
                title: "Approved",
                text: "Request has been approved and sent to HR."
            });
