<?php
// modules/officer/sidebar.php
require_once __DIR__ . "/includes/auth_officer.php";

// Kunin ang kasalukuyang filename para sa Active state
...
$isWorkforceOpen = in_array($current_page, ['roster.php', 'attendance.php', 'timesheet.php']);
...
<script src="../../js/officer/sidebar.js"></script>
