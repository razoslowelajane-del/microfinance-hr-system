...
$managerLabel = $_SESSION['user_role'] ?? 'HR Manager';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Leave Approval | <?php echo htmlspecialchars($managerLabel); ?></title>

    <link rel="icon" type="image/png" href="../../img/logo.png">
    <link rel="stylesheet" href="../../css/manager/leave.css?v=<?php echo time(); ?>">
    ...
    <div class="page-shell">
        <div class="page-header">
            <div class="page-title-wrap">
                ...
                <p>Review officer-endorsed employee leave applications for final HR decision.</p>
            </div>
        ...
        <div class="cards-grid">
            ...
            <div class="summary-card">
                <div class="summary-content">
                    ...
                    <h4>Pending</h4>
                    <p>Not yet endorsed by officer</p>
                </div>
        ...
        <section class="panel">
            <div class="tabs">
                ...
                <button class="tab-btn" data-tab="APPROVED_BY_OFFICER">For HR Review</button>
    ...
    <div class="modal">
        <div class="modal-header">
            <div>
                ...
                <p>Review officer-endorsed leave application before final HR approval.</p>
            </div>
        ...
        <div class="modal-body">
            ...
            <div style="display:grid; gap:18px;">
               ...
               <div class="info-card">
    <h3><i data-lucide="user-check"></i> Officer Approval</h3>
    <div class="detail-grid">
        <div class="detail-item">
            <div class="label">Approved By Officer</div>
            <div class="value" id="mOfficerApprovedBy">-</div>
        </div>
        <div class="detail-item">
            <div class="label">Officer Remarks</div>
            <div class="value" id="mOfficerRemarksText">-</div>
        </div>
    </div>
</div>

                <div class="info-card">
                    <h3><i data-lucide="sticky-note"></i> HR Remarks</h3>
                    <textarea class="notes-textarea" id="hrRemarks" placeholder="Enter remarks for final approval or rejection..."></textarea>
                </div>
            </div>
        </div>
...
<script src="../../js/manager/leave.js?v=<?php echo time(); ?>"></script>
</body>
</html>